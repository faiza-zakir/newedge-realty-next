  ...
  return (
    <div className="terms_intro_sec mt-60">
      <Container>
        ...
        <h2 className="main_sec_heading">Terms & Condition</h2>
        <div className="content_wrap">
          <p>
            NEWEDGE Realty Pvt. Ltd. is one of the leading players in property
            business since 16 years. We are one of the recognized and most
            trusted names in providing Real Estate and Property Services in
            Ahmedabad.
          </p>
          <p>
            Our company provides best resource pool of residential, commercial
            and industrial properties to customers and business owners which
            lends them a helping hand in buying, selling and rental requirements
            of properties.
          </p>
          <p>
